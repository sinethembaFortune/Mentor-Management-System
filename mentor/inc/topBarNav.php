...
<nav class="navbar navbar-expand-lg navbar-dark bg-gradient-purple fixed-top" id="topNavBar">
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link <?= isset($page) && $page == 'register'? "active" : '' ?>" aria-current="page" href="./?p=register">Register</a></li>
                    </ul>
                    ...
                    <div class="d-flex align-items-end">
                      <div class="navbar-nav nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <span><img src="<?= validate_image($_settings->userdata('image_path')) ?>" alt="user_avatar" id="user_avatar" class="img-fluid img-thumbnail rounded-circle border-dark"></span> Hello, Mr <?= $_settings->userdata('lastname') ?>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                          <a class="dropdown-item" href="./?p=manage_account">Manage Account</a>
                          <a class="dropdown-item" href="<?= base_url ?>classes/Login.php?f=logout_mentor">Logout</a>
                        </div>
                      </div>
                    </div>
                </div>

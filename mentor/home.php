...
<div class="content py-5 mt-5">
    <div class="container">
		...
		<label for="studentno" class="control-label"><b>YOU ARE AVAILABLE!!  </b>Click button if you are Unavailable</label>
		...
		<label for="studentno" class="control-label"><b>YOU ARE UNAVAILABLE!! </b> Click button if you are Available</label>

...
<?php $page = isset($_GET['page']) ? $_GET['page'] : 'home';  ?>
  ...
  <!-- /.login-logo -->
<center>
    <img src="<?= validate_image($_settings->info('logo')) ?>" alt="System Logo" class="img-thumbnail squere" id="logo-img" style="width: 100%;">
</center>

  <div class="clear-fix my-2"></div>
  <div class="card card-outline card-purple">
    <div class="card-header text-center">
      <a href="./" class="h4 text-decoration-none"><b>Mentee Login Panel</b></a>
    </div>
    <div class="card-body">

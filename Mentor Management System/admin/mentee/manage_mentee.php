...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `mentee` where id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="card card-outline card-purple">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Mentee Details</h3>
	</div>
	<div class="card-body">
		<form action="" id="mentee-form">
			...
			<div class="form-group">
                ...
                <input name="studentno" id="studentno"class="form-control rounded-0"  value="<?php echo isset($studentno) ? $studentno : ''; ?>" required></input>
			</div>
            <div class="form-group">
			...
			<div class="form-group">
				...
				<small><em class="text-muted">Fill only to update Mentee's Password</em></small>
			</div>
            <div class="form-group">
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-success" form="mentee-form">Save</button>
		<a class="btn btn-flat btn-danger" href="?page=mentee">Cancel</a>
	</div>
</div>
<script>

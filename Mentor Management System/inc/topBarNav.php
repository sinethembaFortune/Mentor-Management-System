            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link <?= isset($page) && $page == 'mentor_available'? "active" : '' ?>" href="./?p=mentor_available">Available Mentors</a></li>
						<li class="nav-item"><a class="nav-link <?= isset($page) && $page == 'list_of_All_mentor'? "active" : '' ?>" href="./?p=list_of_All_mentor">List of All Mentors</a></li>
                    </ul>
                    ...
                    <div class="d-flex align-items-end">
                      <div class="navbar-nav nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                          ...
                          <a class="dropdown-item" href="./classes/Login.php?f=logout_mentee">Logout</a>
                        </div>
                      </div>
                    </div>
                  <?php else: ?>
                    <a href="./login.php" class="text-reset text-decoration-none mx-2"><b>Login</b></a> 
                    <a href="./register.php" class="text-reset text-decoration-none mx-2"><b>Sign-Up</b></a>
                    <a href="./mentor/login.php" class="text-reset text-decoration-none mx-2"><b>Mentor Panel</b></a>

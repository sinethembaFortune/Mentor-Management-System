  ...
  <div class="d-flex  justify-content-center align-items-center col-lg-7 bg-gradient-light text-dark">
    <div class="card card-outline card-purple w-75">
      <div class="card-header text-center">
        <a href="./" class="text-decoration-none text-dark"><b>Create an Account - Mentee</b></a>
      </div>
      <div class="card-body">
        <form id="register-frm" action="" method="post">
          ...
          <div class="row">
			...
			<div class="form-group col-md-10">
                  <select name="stream" id="stream" class="custom-select custom-select-sm form-control-border" required>
                    <option>Computer Science</option>
                    <option>it</option>
                  </select>
                  <small class="ml-3">Stream/course</small>
            </div>
            <div class="form-group col-md-6">
          ...
          <div class="row">
            <div class="form-group col-md-12">
              <small class="ml-3">Student Number</small>
             
			  <input type="text" name="studentno" id="studentno" placeholder="Enter Student Number" class="form-control form-control-sm form-control-border" required>
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="form-group col-md-6">
                <input type="email" name="email" id="email" placeholder="studentNo@tut4life.ac.za" class="form-control form-control-sm form-control-border" required>
